...
global.owner = process.env.OWNER_NUMBER  || '263786644244' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=yAE3nJjK#VRIgZD1xd7MfgtTctNuUPqRx6xSipOtQ4yvMZEXqXCY' ,
