...
global.owner = process.env.OWNER_NUMBER  || '263713090797' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uQsFgRBa#NG-meRnJnMxf_4clGNa0TFgbA-OUegoNH-qRj2QyOdY' ,
